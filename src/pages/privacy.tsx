	...
	return (
		<div className="flex w-full flex-col items-center bg-discord-dark">
			...
			<main className="max-w-4xl">
				...
				<Link href="#log-data">
					<a className="mx-3 text-xl font-bold uppercase text-gray-200 sm:mx-0 sm:text-3xl">Log Data</a>
				</Link>
				...
				<Link href="#cookies">
					<a className="mx-3 text-xl font-bold uppercase text-gray-200 sm:mx-0 sm:text-3xl">Cookies</a>
				</Link>
				...
				<Link href="#security">
					<a className="mx-3 text-xl font-bold uppercase text-gray-200 sm:mx-0 sm:text-3xl">Security</a>
				</Link>
				...
				<Link href="#links-to-other-sites">
					<a className="mx-3 text-xl font-bold uppercase text-gray-200 sm:mx-0 sm:text-3xl">Links to Other Sites</a>
				</Link>
				...
				<Link href="#children-privacy">
					<a className="mx-3 text-xl font-bold uppercase text-gray-200 sm:mx-0 sm:text-3xl">Children&apos;s Privacy</a>
				</Link>
				...
				<Link href="#contact">
					<a className="mx-3 text-xl font-bold uppercase text-gray-200 sm:mx-0 sm:text-3xl">Contact Us</a>
				</Link>
