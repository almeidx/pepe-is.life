	...
	return (
		<div className="flex w-full flex-col items-center bg-discord-dark">
			...
			<header className="flex flex-col items-center justify-center pt-3 sm:pt-1">
				<h1 className="text-3xl font-bold text-white sm:text-4xl">Terms and Conditions</h1>
			...
			<main className="max-w-4xl">
				...
				<Link href="#age-requirement">
					<a className="mx-3 text-xl font-bold uppercase text-gray-200 sm:mx-0 sm:text-3xl">Age requirement</a>
				</Link>
				...
				<Link href="#links-to-other-resources">
					<a className="mx-3 text-xl font-bold uppercase text-gray-200 sm:mx-0 sm:text-3xl">Links to other resources</a>
				</Link>
				...
				<Link href="#prohibited-uses">
					<a className="mx-3 text-xl font-bold uppercase text-gray-200 sm:mx-0 sm:text-3xl">Prohibited uses</a>
				</Link>
				...
				<Link href="#intellectual-property-rights">
					<a className="mx-3 text-xl font-bold uppercase text-gray-200 sm:mx-0 sm:text-3xl">
				...
				<Link href="#severability">
					<a className="mx-3 text-xl font-bold uppercase text-gray-200 sm:mx-0 sm:text-3xl">Severability</a>
				</Link>
				...
				<Link href="#changes">
					<a className="mx-3 text-xl font-bold uppercase text-gray-200 sm:mx-0 sm:text-3xl">Changes and amendments</a>
				</Link>
				...
				<Link href="#contact">
					<a className="mx-3 text-xl font-bold uppercase text-gray-200 sm:mx-0 sm:text-3xl">Contacting us</a>
				</Link>
